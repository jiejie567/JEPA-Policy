...
Download the anonymous review snapshot and enter the deployment directory:

```bash
curl -L https://anonymous.4open.science/api/repo/JEPAPolicy2701/zip \
  -o JEPAPolicy2701.zip
