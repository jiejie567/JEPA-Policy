...
def get_network(
    ...
    from mip.networks.chitfm_dual import (
        ChiDualCrossTransformer,
        ChiDualIndependentTransformer,
    )
    ...
    network_class = {
        ...
        "chitransformer_dual_independent": ChiDualIndependentTransformer,
        "chitransformer_dual_cross": ChiDualCrossTransformer,
        "chiunet": ChiUNet,
    ...
    if network_config.network_type == "mlp":
        ...
        "chitransformer_dual_independent",
        "chitransformer_dual_cross",
    ):
        return network_class(
            **common_params,
            d_model=network_config.emb_dim,
            ...
            n_future_tokens=network_config.n_future_tokens,
            future_out_dim=future_out_dim or network_config.emb_dim,
            future_d_model=network_config.future_emb_dim,
            future_nhead=network_config.future_n_heads,
            future_num_layers=network_config.future_num_layers,
            future_ffn_dim=network_config.future_ffn_dim,
            use_causal_mask=network_config.use_causal_mask,
            use_memory_mask=network_config.use_memory_mask,
        )
